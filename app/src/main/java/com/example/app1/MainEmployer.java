...
public class MainEmployer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPost.setOnClickListener(v -> {
            ...
            String jobField = spinnerJobField.getSelectedItem().toString();
            String specificJob = spinnerSpecificJob.getSelectedItem().toString();
            ...
            FBRef.refPosts.child(uid).child(postKey).setValue(jobPost)
