...
public class MainEmployer extends AppCompatActivity {
    ...
    private Spinner spinnerAge, spinnerRegion, spinnerCity,
            spinnerJobType, spinnerJobField, spinnerSpecificJob;
    private EditText edittextHourlyRate, edittextAdditionalInfo, edittextPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edittextHourlyRate = findViewById(R.id.edittext_hourly_rate);
        edittextAdditionalInfo = findViewById(R.id.edittext_additional_info);
        edittextPhone = findViewById(R.id.edittext_phone);
        buttonPost = findViewById(R.id.button_post);



        // تعبئة القوائم (قِيم تجريبية يمكنك تعديلها لاحقًا)
        ...
        spinnerRegion.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (selectedRegion) {
                    case "אזור צפון":
                        cityOptions = new String[]{"בית שאן", "דליה", "דלית אל-כרמל", "חיפה", "טבריה", "טירת כרמל", "כרמיאל", "מג'דל כרום", "מעלות תרשיחא", "נהריה", "נווה יוסף", "נצרת", "נשר", "סכנין", "עילוט", "עכו", "עפולה", "קריית אליעזר", "קריית אתא", "קריית ביאליק", "קריית חיים", "קריית ים", "קריית מוצקין", "קריית שמונה", "שפרעם"};
                        break;
                    case "אזור מרכז ושרון":
                        cityOptions = new String[]{"אור עקיבא", "בני ברק", "בת ים", "גבעתיים", "הוד השרון", "הרצליה", "זכרון יעקב", "חדרה", "חולון", "כפר סבא", "לוד", "נתניה", "פרדס חנה - כרכור", "פתח תקווה", "ראשון לציון", "רחובות", "רמלה", "רמת גן", "רעננה", "תל אביב - יפו"};
                        break;
                    case "אזור הדרום":
                        cityOptions = new String[]{"אופקים", "אילת", "אשדוד", "אשקלון", "באר שבע", "דימונה", "ירוחם", "נתיבות", "ערד", "שדרות"};
                        break;
                    case "אזור ירושלים":
                        cityOptions = new String[]{"אלקנה", "אריאל", "בית אל", "בית שמש", "ביתר עילית", "גבעת זזאב", "גוש עציון", "ירושלים", "מבשרת ציון", "מודיעין עילית", "מעלה אדומים", "קדומים", "קרני שומרון"};
                        break;
                    default:
        ...
        buttonPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String jobType = (String)spinnerJobType.getSelectedItem();
                String hourlyRate = edittextHourlyRate.getText().toString();
                String jobField = (String)spinnerJobField.getSelectedItem();
                String specificJob = (String)spinnerSpecificJob.getSelectedItem();
